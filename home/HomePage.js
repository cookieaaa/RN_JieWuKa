...
const BANNER_IMGS = [
    require('./../App/Resoures/Images/banner/1.jpg'),
    require('./../App/Resoures/Images/banner/2.jpg'),
    require('./../App/Resoures/Images/banner/3.jpg'),
    require('./../App/Resoures/Images/banner/4.jpg')
];
